...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    @Resource
    private AiBaseGeneratorServiceFactory aiAppTitleGeneratorServiceFactory;
    ...
    public Long createApp(AppAddDto appAddDto, User loginUser) {
        ...
        // 使用基本对话ai模型生成应用名称
        AiBaseGeneratorService aiAppTitleGeneratorService = aiAppTitleGeneratorServiceFactory.createAiBaseGeneratorService();
    ...
    public String deployApp(Long appId, User loginUser) {
        ...
        try {
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "应用部署错误:" + e.getMessage());
        }
    ...
    @Override
    public QueryWrapper getQueryWrapper(AppQueryDto appQueryRequest) {
